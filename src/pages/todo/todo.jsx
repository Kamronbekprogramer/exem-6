...
//       index === currentTask.index ? { ...task, status: currentTask.status } : task
//     );
...
//               </CardContent>
//               <CardActions>
//                 <Button size="small" onClick={() => openModal(task, index)} variant="outlined" endIcon={<EditIcon />}>Edit</Button>
//                 <Button size="small" onClick={() => deleteTask(index)} variant="outlined" color='error' startIcon={<DeleteIcon />}>Delete</Button>
//               </CardActions>
//             </Card>
//           </Grid>
//         ))}
            ...
            {getTasksByStatus(status).map((task, index) => (
              <Grid item xs={12} sm={6} md={4} key={index}>
                <Card className='border'>
                  ...
                  <CardActions>
                    <Button size="small" onClick={() => openModal(task, tasks.findIndex(t => t === task))} variant="outlined" endIcon={<EditIcon />}>Edit</Button>
                    <Button size="small" onClick={() => deleteTask(tasks.findIndex(t => t === task))} variant="outlined" color='error' startIcon={<DeleteIcon />}>Delete</Button>
                  </CardActions>
                </Card>
              </Grid>
            ))}
